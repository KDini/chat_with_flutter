    ...
    return showDialog(
      ...
      builder: (BuildContext build) {
        return (Theme.of(context).platform == TargetPlatform.iOS)
            ? new CupertinoAlertDialog(title: title, content: subtitle, actions: _action(build),)
            : new AlertDialog(title: title, content: subtitle, actions: _action(build),);
      }
    );
  }

  List<Widget> _action(BuildContext build) {
    List<Widget> widgets = [];
